        ...
        <TableBody>
          {ProjectCategories.map((ProjectCategories) => (
            ...
            >
              ...
              <TableCell><DescriptionComponent description={ProjectCategories.description} maxLength={60} /></TableCell>
              <TableCell><DescriptionComponent description={ProjectCategories.description_pashto} maxLength={60} /></TableCell>
              <TableCell><DescriptionComponent description={ProjectCategories.description_dari} maxLength={60} /></TableCell>
              <TableCell>
                <IconButton
